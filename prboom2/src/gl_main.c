...
void gld_InitTextureParams(void)
{
  ...
  tex_filter_t params[filter_count] = {
    ...
    {true,  GL_NEAREST,  GL_LINEAR_MIPMAP_NEAREST, "GL_NEAREST",  "GL_LINEAR_MIPMAP_NEAREST"},
    {true,  GL_NEAREST,  GL_LINEAR_MIPMAP_LINEAR,  "GL_NEAREST",  "GL_LINEAR_MIPMAP_LINEAR"},
  };
